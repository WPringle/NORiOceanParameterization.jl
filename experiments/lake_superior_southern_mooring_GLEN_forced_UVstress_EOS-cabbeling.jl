...
#                            The fit was done at the eastern mooring's latitude but over
#                            Z ∈ [-400, 0] m, so it fully covers this mooring's 384 m depth
#                            too — the tiny latitude difference (47°2.0'N vs 47°32.2'N) has
#                            a negligible effect on the pressure-from-depth conversion, so
#                            the coefficients are reused as-is rather than refit.
...
#
# Usage:
#   julia lake_superior_southern_mooring_GLEN_forced_UVstress.jl <winter_year> [closure_name] [forcing_source] [eos]
...
#         julia lake_superior_southern_mooring_GLEN_forced_UVstress.jl 2010 CATKE cabbelingthermobaric
#         julia lake_superior_southern_mooring_GLEN_forced_UVstress.jl 2010 CATKE teos10cabbeling
#
...
# (Fit at the eastern mooring's latitude/depth range, but reused here unchanged — the
# fit already spans Z ∈ [-400, 0] m, covering this mooring's 384 m depth, and the small
# latitude difference has a negligible effect on the pressure-from-depth conversion.)
#
